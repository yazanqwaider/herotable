...
$.extend(Herotable.prototype, {
    ...
    removeTableControlBtn: function() {
        this.table.closest('.herotable-wrapper').find('.control-layout').remove();
        this.hidden_columns = [];
    },
